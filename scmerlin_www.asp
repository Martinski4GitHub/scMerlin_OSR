...
<td class="settingname">Enable WebUI dropdown sub-menus<br/></td>
<td class="settingvalue">
<input type="radio" name="scMerlin_WebUIDropdowns" id="scMerlin_WebUIDropdowns_Enabled" class="input" value="Enable">Yes
<input type="radio" name="scMerlin_WebUIDropdowns" id="scMerlin_WebUIDropdowns_Disabled" class="input" value="Disable" checked>No
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="button" style="margin-left:100px;" onclick="Save_WebUIDropdowns();" value="Save"
       id="btnSaveWebUIDropdowns" class="button_gen savebutton"
       title="Apply and save selected option for WebUI dropdown sub-menus" name="button">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<span id="scMerlin_WebUIDropdowns_Status" style="color:#FFCC00;"></span>
</td>
</tr>
</table>
