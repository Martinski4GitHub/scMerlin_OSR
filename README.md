...
## NOTE:
The "Services" and "VPN" sections on the WebUI page have the option to send a request to "restart" a selected service. However, that does not mean that the service is indeed enabled or configured to be started.
