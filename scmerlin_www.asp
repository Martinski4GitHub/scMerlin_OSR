...
/**-------------------------------------**/
/** Added by Martinski W. [2026-Jul-24] **/
/**-------------------------------------**/
function CelsiusToFahrenheit (temptrValue)
{ return round((temptrValue * 1.8) + 32, 1).toFixed(1); }
...
{
    let temperatureVal = '[N/A]', wifiTempInfo, wifiTempValue, wifiTempUnits;
    ...
    if (temperatureVal.length > 1 && temperatureVal !== '[N/A]')
    {
        wifiTempInfo = temperatureVal.split('&deg;');
        wifiTempUnits = wifiTempInfo[1];
        wifiTempValue = parseInt(wifiTempInfo[0], 10);

        if (unitsFahrenheit && ! isNaN(wifiTempValue))
        {
            wifiTempUnits = 'F';
            wifiTempValue = CelsiusToFahrenheit(wifiTempValue);
        }
        temperatureVal = wifiTempValue + '&deg;' + wifiTempUnits;
    }
...
**----------------------------------------**
-->
<tr class="even" id="rowEnableWebUIDropdowns">
<td class="settingname">
<label for="scMerlin_WebUIMods">
   <a class="hintstyle" name="ENABLE_WEBUI_MODS" href="javascript:void(0);"
      onclick="ShowHintMsg(this);">Enable additional WebUI modifications</a>
</label>
</td>
<td class="settingvalue">
<input type="radio" name="scMerlin_WebUIMods" id="scMerlin_WebUIMods_Enabled" class="input" value="Enable">Yes
<input type="radio" name="scMerlin_WebUIMods" id="scMerlin_WebUIMods_Disabled" class="input" value="Disable" checked>No
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="button" style="margin-left:100px;" onclick="Save_WebUIMods();" value="Save"
       id="btnSaveWebUIDropdowns" class="button_gen savebutton"
       title="Apply and save selected option for WebUI modifications" name="button">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<span id="scMerlin_WebUIMods_Status" style="color:#FFCC00;"></span>
</td>
</tr>
</table>
...
<tr>
<td colspan="3">Temperatures (click to expand/collapse)</td>
</tr>
</thead>
<tr>
<td class="temperatureInfo">Temperatures</td>
<td class="metricname">
<input type="checkbox" name="temptrUnitsF" id="temptrUnitsF" class="input"
  onclick="ToggleTemperatureUnits(this)"
  value="false"/><label for="temptrUnitsF">&deg;F</label>
</td>
<td id="temptrInfo" class="settingvalue"></td>
</tr>
</table>
<tr><td align="center" style="padding: 0px;">
<table width="100%" border="1" align="center" cellpadding="4" cellspacing="0" bordercolor="#6b8fa3" class="FormTable SettingsTable">
